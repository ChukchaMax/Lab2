...
> Выполнить 5 заданий с массивом  чисел Фибоначчи:
> 1. Программа получает на вход число N. Нужно создать массив длины N из первых чисел Фибоначчи.
> 2. Отсортировать массив таким образом, чтобы сначала шли однозначные числа по убыванию, потом двузначные по убыванию и т.д.
> Например: `8, 5, 2, 54, 23, 400, 233...`
> 3. Найти и вывести сумму всех нечетных чисел в массиве.
> 4. Вывести двоичное представление элементов массива.
> 5. Заменить каждый элемент массива на сумму цифр числа и вывести получившийся массив

Данную задачу можно понять по разному.
